      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 text-sm font-mono mb-8 max-w-xl">
            Live architecture walkthrough — agent collusion detection, HMAC signing, and real-time threat response.
          </p>
          ...
          <div className="relative rounded-sm overflow-hidden border border-zinc-800 bg-black group">
            ...
            {!playing && (
              <button
                ...
                style={{ top: "2.25rem" }} /* offset below chrome bar */
              >
                <div className="w-14 h-14 rounded-full border border-cyan-500/50 bg-cyan-500/10 flex items-center justify-center hover:bg-cyan-500/20 transition-colors">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    className="w-5 h-5 text-cyan-400 ml-0.5"
                    aria-hidden="true"
                  >
                    <path
                      d="M6 4.75L19.25 12L6 19.25V4.75Z"
                      fill="currentColor"
                      strokeLinecap="round"
          ...
          <p className="mt-4 text-[10px] font-mono text-zinc-700 uppercase tracking-widest">
            Sentient Sync Engine&nbsp;&nbsp;·&nbsp;&nbsp;Architecture Demo&nbsp;&nbsp;·&nbsp;&nbsp;eMerge Americas 2026
          </p>
        </motion.div>
      </div>
    </section>
