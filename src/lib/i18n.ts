...
export const translations = {
  en: {
    ...
    hero: {
      ...
      credentials:    "AGI Cybersecurity Architect  //  BS Cybersecurity, Champlain College (4.0 GPA)  //  Visa Inc. GenAI Ambassador+",
      title1:         "The",
      ...
      identityP3:     "Now completing a BS Cybersecurity at Champlain College (4.0 GPA) and architecting the Sentient Sync Engine — a production-grade AGI collusion detection framework aligned to OWASP LLM Top 10, NIST CSF, and IEEE standards. Featured at eMerge Americas, April 23, 2026.",
    ...
    roadmap: {
      ...
      phases: [
        ...
        { date: "MAR 2026", task: "Academic Finalization",             detail: "BS Cybersecurity, Champlain College — 4.0 GPA. CMIT-235 Advanced Python and MGMT-260 Project Management completed." },
  ...
  de: {
    ...
    hero: {
      ...
      credentials:    "AGI-Cybersicherheitsarchitekt  //  B.Sc. Cybersicherheit, Champlain College (4,0 GPA)  //  Visa Inc. GenAI-Botschafter+",
      title1:         "Die",
      title2:         "Sentient Sync",
      title3:         "Engine",
    ...
    roadmap: {
      ...
      phases: [
        ...
        { date: "Mär. 2026", task: "Akademischer Abschluss",                  detail: "B.Sc. Cybersicherheit, Champlain College — 4,0 GPA. CMIT-235 Advanced Python und MGMT-260 Projektmanagement abgeschlossen." },
